...
try {
    ...
    echo '<script language="javascript">alert("Computadora añadida correctamente"); window.location.href = "../../vista/index/indexPC.php";</script>';
} catch (PDOException $e) {
    echo '<script language="javascript">alert("Error al añadir la computadora: ' . $e->getMessage() . '");</script>';
}
?>
