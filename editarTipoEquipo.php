...
$_SESSION["timeout"] = time() + (30 * 60); // 30 minutos
    ...
    $sql0="SELECT tipo_equipo.*, tipo_equipo.id_tipo_equipo AS id
    FROM tipo_equipo
...
<nav class="navbar">
    ...
    <div class="users-table">
        ...
        <div class="users-form">
            <form id="nuevo" action="editarTipoEquipoFuncion.php" method="POST">
                ...
                <option value="USB" <?= $row0['teclado'] == 'USB' ? 'selected' : '' ?>>PC</option>
