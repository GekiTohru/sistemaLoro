...
$_SESSION["timeout"] = time() + (30 * 60); // 30 minutos
    ...
    $sql0="SELECT fabricante.*, fabricante.id_fabricante AS id
    FROM fabricante
...
<nav class="navbar">
    ...
    <div class="users-table">
        ...
        <div class="users-form">
            <form id="nuevo" action="editarFuncion.php?redirect=fabricante" method="POST">
            <input type="hidden" name="id" value="<?= $row0['id']?>">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_fabricante">Fabricante</label>
                <input type="text" name="nombre_fabricante" id="nombre_fabricante" placeholder="Ingrese el fabricante" value="<?= $row0['nombre']?>" required>
                </div>
</div>
