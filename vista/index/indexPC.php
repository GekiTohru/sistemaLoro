...
<input type="hidden" id="filterInput">
        <table id="tablaPC" class="display responsive nowrap" style="width:100%">    
                ...
                foreach ($usuariosPorPC as $idPC => $usuarios) {
                  ...
                  echo '<td>';
                  echo '<div><a href="../editar/editarPC.php?id='. $fila['id']. '" class="users-table--edit">Editar</a></div>';
                  if ($_SESSION['permisos'] == 1) {
                    echo '<div><a href="#" class="users-table--edit" onclick="eliminarFuncion('.$fila['id'].')">Eliminar</a></div>';
                  }
                  echo '<div><a href="../../reporte/auditoriaPcPdf.php?id='. $fila['id']. '" class="users-table--edit">Auditoría</a></div>';
                  echo '<div><a href="../../reporte/fichaPcPdf.php?id='. $fila['id']. '" class="users-table--edit">Ficha</a></div>';
                  echo '<div><a href="../../reporte/constanciaPc.php?id='. $fila['id']. '" class="users-table--edit">Constancia</a></div>';
                  echo '</td>';
