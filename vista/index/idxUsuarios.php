    ...
    <div class="users-table">
        ...
        <table id="tablaUser" class="display responsive nowrap" style="width:100%">    
                ...
                foreach ($user as $fila) {
                  ...
                  echo '<div><a href="../editar/editarUsuario.php?id='. $fila['id_usuario']. '" class="users-table--edit" title="Editar"><img width="30" height="30" src="../../img/edit.svg" alt="Icono SVG"></a></div>';
