...
$sql = "SELECT * FROM plan_tlf
WHERE plan_tlf.activo = 1";
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        ...
        data: {
          ...
          id_columna: "id_plan",
          id: id,
          redirect: "../vista/index/idxPlan.php"
        }
      }).done(function() {
        Swal.fire({
          title: "Eliminado!",
          ...
          if (result.isConfirmed) {
            window.location.href = "../index/idxPlan.php";
          }
        });
      });
    }
