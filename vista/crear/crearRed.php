...
<body>
    <div class="users-table">
        <h2 style="text-align: center;">Añadir Red LAN</h2>
        <div class="users-form">
            <form id="nuevo">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_red">Red LAN</label>
                <input type="text" name="nombre_red" id="nombre_red" placeholder="Ingrese la red" value="" required>
                </div>
</div>
                <input type="submit" value="Añadir Red LAN">
            </form>
        </div>
    ...
    function crear() {
            ...
            if (data === 'ok') {
                    Swal.fire({
                        icon: "success",
                        title: "Tipo de red añadido correctamente",
                ...
                Swal.fire({
                    icon: "error",
                    title: "Error al crear el tipo de red",
