...
<body>
    <div class="users-table">
        <h2 style="text-align: center;">Añadir nuevo sistema operativo</h2>
</style>
        <div class="users-form">
            <form id="nuevo">
                ...
                <input type="text" name="nombre_pcso" id="nombre_.pcso" placeholder="Ingrese el nombre" value="" required>
                </div>
</div>
                <input type="submit" value="Añadir nuevo S.O.">
            </form>
        </div>
        <script>
    ...
    function crear() {
            ...
            if (data === 'ok') {
                    Swal.fire({
                        icon: "success",
                        title: "Sistema operativo añadido correctamente",
                ...
                Swal.fire({
                    icon: "error",
                    title: "Error al crear el sistema operativo",
