...
<nav class="navbar">
    ...
    <div class="users-table">
        ...
        <div class="users-form">
            <form id="nuevo" action="../../controlador/crear/crearFuncion.php?redirect=sucursal" method="POST">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_sucursal">Sucursal</label>
                <input type="text" name="nombre_sucursal" id="nombre_sucursal" placeholder="Ingrese el nombre" value="">
                </div>
</div>
                <input type="submit" value="Añadir nueva sucursal">
            </form>
        </div>
