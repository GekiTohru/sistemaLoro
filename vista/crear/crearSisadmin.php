...
<body>
    <div class="users-table">
        <h2 style="text-align: center;">Agregar Sistema Administrativo</h2>
        <div class="users-form">
            <form id="nuevo">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_sisadmin">Sistema Administrativo</label>
                <input type="text" name="nombre_sisadmin" id="nombre_sisadmin" placeholder="Ingrese el nombre" value="" required>
                </div>
</div>
                <input type="submit" value="Añadir Sistema Administrativo">
            </form>
        </div>
        <script>
    ...
    function crear() {
            ...
            if (data === 'ok') {
                    Swal.fire({
                        icon: "success",
                        title: "Sistema administrativo añadido correctamente",
                ...
                Swal.fire({
                    icon: "error",
                    title: "Error al crear el sistema administrativo",
