...
<nav class="navbar">
    ...
    <div class="users-table">
        <h2 style="text-align: center;">Añadir nueva área</h2>

        <div class="users-form">
            <form id="nuevo" action="../../controlador/crear/crearFuncion.php?redirect=area" method="POST">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_area">Área</label>
                <input type="text" name="nombre_area" id="nombre_area" placeholder="Ingrese el nombre" value="" required>
                </div>
</div>
                <input type="submit" value="Añadir nueva área">
            </form>
        </div>
