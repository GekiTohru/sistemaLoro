...
<nav class="navbar">
    ...
    <div class="users-table">
        <h2 style="text-align: center;">Añadir nuevo fabricante</h2>
        <div class="users-form">
            <form id="nuevo" action="../../controlador/crear/crearFabricanteFuncion.php?redirect=fabricante" method="POST">
                ...
                <input type="submit" value="Añadir nuevo fabricante">
            </form>
        </div>
