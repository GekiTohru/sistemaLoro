...
$conexion = $conexionObj->ConexionBD(); 
    ...
    $sql="SELECT sucursal.*, sucursal.id_sucursal AS id
    FROM sucursal
...
<nav class="navbar">
    ...
    <div class="users-table">
        <h2 style="text-align: center;">Editar Sucursal</h2>
        <div class="users-form">
            <form id="nuevo" action="../../controlador/editar/editarFuncion.php?redirect=sucursal" method="POST">
            <input type="hidden" name="id" value="<?= $row0['id']?>">
                <div id="entradas" style="display: flex; flex-wrap: wrap;">
                <div class="inputs">
                <label for="nombre_sucursal">Operadora</label>
                <input type="text" name="nombre_sucursal" id="nombre_sucursal" placeholder="Ingrese la sucursal" value="<?= $row0['nombre']?>" required>
                </div>
</div>
